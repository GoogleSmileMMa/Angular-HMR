...
export class EmployeeListComponent implements OnInit {
  ...
  fetchData(){
    ...
    this.employeesService
      ...
      .subscribe((res:HttpResponse< Employee[]>) =>{
        ...
        //总条数
        this.total = +res.headers.get('X-Total-Count') //+将字符串转换成整数
        this.employeesList = res.body
        this.isLoading = false
    })
  }

  //列表追踪(如果数据更新的话，Angular会只更新新的数据，从而提高了列表渲染的性能)
  ...
  editEmployee(){
    ...
    this.employeesService.updateEmployeeById(this.editEmployeeId, params).subscribe((res: Employee) =>{
